...
GameManagerBotHard::GameManagerBotHard(const Player& p1) : p1(p1), computer(p1.getSymbol() == 'x' ? 'o' : 'x'), board() {}

void GameManagerBotHard::runGame()
{
    std::cout << std::endl;
    board.displayBoard();
...
void GameManagerBotHard::switchPlayeer()
{
    if(currentPlayer == &p1)
    {
...
bool GameManagerBotHard::promptRestart()
{
    char y;
